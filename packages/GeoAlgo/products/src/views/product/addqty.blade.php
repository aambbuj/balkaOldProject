...
<div class="col-xs-12 col-sm-12 col-md-12">
        <div class="alert alert-danger" role="alert" id="show_error" style="display: none;">
          This is a warning alert—check it out!
               ...
               <div class="card-body">
                  <form action="{{ route('product.qtystore') }}" method="POST" id="category_form" class="form" enctype="multipart/form-data">
                    @csrf
                    
                    <input type="hidden" name="id" value="{{ $product->id }}"/>

                  <div class="form-group">
                    <strong>Add the Quantity</strong>
                    <input type="text" name="qty" class="form-control" value="" placeholder="Add the Quantity" required>
                  </div>
                  </form>
                </div>
