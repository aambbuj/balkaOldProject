...
<div class="col-xs-12 col-sm-12 col-md-12">
        <div class="alert alert-danger" role="alert" id="show_error" style="display: none;">
          This is a warning alert—check it out!
               ...
               <div class="card-body">
                  <form action="{{ route('brand.store') }}" method="POST" id="brand_form" class="form" enctype="multipart/form-data">
                    @csrf
                    
                    @if($edit == true && !empty($brand))
                    <input type="hidden" name="user_id" value="{{ $brand->id }}"/>
                    <input type="hidden" name="brand_id" value="{{ $brand->brand->id }}"/>
                    <input type="hidden" name="vendor_id" value="{{ $brand->vendorAddress->id }}"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" class="form-control" value="{{ ($edit == true && !empty($brand->vendorAddress))?$brand->phone:'' }}" placeholder="Office Contact" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="brand_image" class="form-control" value="{{ ($edit == true && !empty($brand))?$brand->brand->brand_image:'' }}" placeholder="Brand Image" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong>Brand Percentage</strong>
                                <input type="number" name="percentage" class="form-control" value="{{ ($edit == true && !empty($brand))?$brand->brand->percentage:'' }}" placeholder="Brand Percentage" required>
                            </div>
                        </div>
