...
<section class="sign-up">
  ...
  <div class="modal__item">
    ...
    <div class="login-info">
      ...
      <a class="login-info__item" href="{{route('customer.log-in')}}">
        Log in
      </a>
      </p>
    </div>
    <form class="login-form" action="{{route('customer.signup')}}" method="POST">
    @csrf
      <div class="row">
                    <div class="col-md-6">
                        <input class="login-form__input" type="text" name="f_name" placeholder="Enter your first name" required>
                    </div>
                    <div class="col-md-6">
                        <input class="login-form__input" type="text" name="l_name" placeholder="Enter your Last name" required>
                    </div>
                </div>
      <input class="login-form__input" type="email" name="email" placeholder="email" required>
      <input class="login-form__input" type="password" name="password" placeholder="choose password" required>
      <input class="login-form__input" type="password" name="confirm_password" placeholder="repeat password" required>
      <input class="login-form__btn" type="submit" value="Submit">
    </form>
    <!-- <div class="close-btn">
